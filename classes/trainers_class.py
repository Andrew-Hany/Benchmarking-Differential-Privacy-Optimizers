...
from privacy_engines.Matrix_multi_epoch_privacy_engine import Matrix_multi_epoch_PrivacyEngine
from privacy_engines.Matrix_multi_epoch_lambda_privacy_engine import Matrix_multi_epoch_lambda_PrivacyEngine
...
class DP_Matrix_train_epsilon_Lambda(BaseOptimizer_trainer):
    @staticmethod
    def train(
        model: torch.nn.Module,
        model_type,
...
@register_optimizer("Matrix_multi_epoch")
class DP_Matrix_multi_train_epsilon(BaseOptimizer_trainer):
    @staticmethod
    def train(
        model: torch.nn.Module,
        model_type,
        ...
        **kwargs):
        ...
        privacy_engine = Matrix_multi_epoch_PrivacyEngine(
            accountant=accountant,
            # accountant='rdp',
            secure_mode=False,  # Should be set to True for production use
        )
...
@register_optimizer("Matrix_multi_epoch_lambda")
class DP_Matrix_multi_train_epsilon_Lambda(BaseOptimizer_trainer):
    @staticmethod
    def train(
        model: torch.nn.Module,
        model_type,
        ...
        **kwargs):
        ...
        privacy_engine = Matrix_multi_epoch_lambda_PrivacyEngine(
            accountant=accountant,
            # accountant='rdp',
            secure_mode=False,  # Should be set to True for production use
        )
