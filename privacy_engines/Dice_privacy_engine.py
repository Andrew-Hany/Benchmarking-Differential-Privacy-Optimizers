...
from Optimizers.Dice_optimizers._init import get_optimizer_class
from Optimizers.Dice_optimizers.DiceSGD import DPOptimizer_Dice



class Dice_PrivacyEngine(PrivacyEngine):
    ...
    def make_private(
        ...
        *,
        ...
        error_max_grad_norm: Union[float, List[float]],
        **kwargs,
    ...
    def _prepare_optimizer(
        ...
        **kwargs,
        ...
        if isinstance(optimizer, DPOptimizer_Dice):
