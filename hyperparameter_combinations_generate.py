...
csv_file_path = saving_module.convert_json_to_csv('Setup2')
...
optimizer_types = ['Matrix_multi_epoch','Matrix_multi_epoch_lambda','sgd']# #sgd, 'Matrix_multi_epoch','Matrix_multi_epoch_lambda','Matrix_single_epoch','Matrix_single_epoch_lambda'
if optimizer_types[0] =='adambc':
    learning_rates = [0.000001,0.00001,0.0001,0.001] # adam
else:
    learning_rates = [ 0.001, 0.01 , 0.1 , 1, 10,100] # 0.001, 0.01 , 0.1 , 1, 10]

batch_sizes = [1024,2048 ] # ,1024,2048 , 
epsilons = [1,10] #10 
seeds = [1324204]#1324204, 22409896603,1443617675,13242043,1023176085,2008379934
num_epochs = [30] 
